  ...
  export const ResponsiveWrapper = styled.div`
    ...
    transition: width 0.5s;
      ...
      :nth-child(2){
        ...
        width:calc(var(500)*1.03);
        height:calc(var(500)*1.03);
        background-image:linear-gradient(0deg, var(--animation-primary-1) 0%, var(--animation-secondary-1) 74%);
        z-index:8;
      ...
      :nth-child(3){
        ...
        z-index:6;
        width:calc(var(500)*1.02);
        height:calc(var(500)*1.02);
        background-image:linear-gradient(0deg, var(--animation-primary-1) 0%, var(--animation-secondary-1) 74%);
        filter:blur(0px);
        animation: var(--animation) 1.5s linear infinite;
      }
    ...
    <s.Screen style={{backgroundImage: "linear-gradient(var(--bg-angle), var(--primary) 0%, var(--secondary) 74%)"}}>
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{backgroundImage:"linear-gradient(var(--main-angle), var(--main-bg-primary) 0%, var(--main-bg-secondary) 74%)", padding: 24, borderRadius:"var(--main-rarius)",}} test>
          ...
          >
            You can only mint 2 {CONFIG.SYMBOL} per Wallet.
          </s.TextTitle>
          <s.SpacerSmall />
            {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              ...
              <>
                ...
                <s.TextDescription
                  style={{ textAlign: "center", color: "var(--alert-text)" }}
                >
                  If Mint Failed then please increase gas fee.
                </s.TextDescription>
                <s.SpacerSmall />
                {blockchain.account === "" ||
